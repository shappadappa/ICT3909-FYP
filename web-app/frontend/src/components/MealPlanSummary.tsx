		...
		<div className="mt-3 flex gap-3">
			<div className="border-walnut-100 flex flex-1 items-center gap-3 rounded-xl border bg-white px-4 py-3">
				...
				<div>
					...
					<p className="text-walnut-800 text-sm font-semibold">21 planned</p>
				</div>
			</div>
			<div className="border-walnut-100 flex flex-1 items-center gap-3 rounded-xl border bg-white px-4 py-3">
				...
				<div>
					...
					<p className="text-walnut-800 text-sm font-semibold">34 items</p>
				</div>
			</div>
			<div className="border-walnut-100 flex flex-1 items-center gap-3 rounded-xl border bg-white px-4 py-3">
				...
				<div>
					<p className="text-walnut-400 text-xs">Est. Cost</p>
					<p className="text-walnut-800 text-sm font-semibold">€87.50</p>
				</div>
			</div>
		</div>
	);
