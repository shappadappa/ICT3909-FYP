...
*Note: `food_embedding.faiss` and `food_density_embedding.faiss` are not included in the repository due to their large size (>100 MB). They can be generated by running the notebooks, or downloaded from the [Google Drive link](https://drive.google.com/drive/folders/18xP_p8C6MNsTHAR0-9VHS4qiftSl8XT5?usp=sharing).*