...
- `MealPlanningEnvironment`: encapsulates all data required for meal planning. This includes available recipes, pantry stock, user preferences, and ingredient costs. It also handles loading recipes from JSON and automatically filters ingredients and recipes based on the user's dietary preferences (ex. gluten-intolerant user preferences results in all gluten-containing recipes and ingredients being excluded).